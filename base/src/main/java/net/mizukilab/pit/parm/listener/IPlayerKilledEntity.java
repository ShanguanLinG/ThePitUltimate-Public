...
/**
 * 2 * @Author: EmptyIrony
 * 3 * @Date: 2020/12/29 22:40
 * 4
 */
@UnknowEntityType
public interface IPlayerKilledEntity {
     ...
     */
    void handlePlayerKilled(int enchantLevel, Player myself, Entity target, AtomicDouble coins, AtomicDouble experience);
