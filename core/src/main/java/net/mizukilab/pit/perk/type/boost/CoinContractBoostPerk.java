...
/**
 * @Author: Misoryan
 * @Created_In: 2021/1/31 18:35
 */

@Passive
public class CoinContractBoostPerk extends AbstractPerk implements IPlayerKilledEntity {

    @Override
    public String getInternalPerkName() {
        return "CoinContractBoost";
    }
    ...
    public void handlePlayerKilled(int enchantLevel, Player myself, Entity target, AtomicDouble coins, AtomicDouble experience) {
        ...
        if (data != null) {
            coins.set((1 + 0.015 * data.getLevel()) * coins.get());
        }
    }
}
