...
/**
 * @Author: Misoryan
 * @Created_In: 2021/3/14 21:29
 */

@ArmorOnly
public class JerryEnchant3 extends AbstractEnchantment implements ITickTask, MovementHandler {
    ...
    @SneakyThrows
    public JerryEnchant3() {
        this.angle = NBSDecoder.parse(ThePit.getInstance().getClass().getClassLoader().getResourceAsStream("stand_proud.nbs"));
        this.demon = NBSDecoder.parse(ThePit.getInstance().getClass().getClassLoader().getResourceAsStream("rapid_as_wildfire.nbs"));
    ...
    public String getUsefulnessLore(int enchantLevel) {
        return "&7此附魔只能通过阵营活动 &b光&c暗&f派系 &7获得."
                + "/s&7向周围的玩家播放音乐."
                + "/s&7天使阵营播放音乐: &bStand Proud"
                + "/s&7恶魔阵营播放音乐: &c疾如猛火 &c&oRapid as Wildfire";
    }
